var awaitingApprovalPropertyController = function () {
    ...
    function registerEvent() {
        ...
        $('body').on('click', '.btn-approval', function (e) {
            ...
            var that = $(this).data('id');
            console.log(that);
            easy2getroom.confirm('Bạn có chắc chắn muốn phê duyệt ?', function () {
                $.ajax({
                    type: 'POST',
                    url: '/Admin/AwaitingApprovalProperty/Approval',
                    data: {
                        Id: that,
                    },
                    dataType: 'text',
                    ...
                    success: function () {
                        easy2getroom.notify('Duyệt bài thành công', 'success');
                    ...
                    error: function (status) {
                        console.log(status);
                        easy2getroom.notify('Duyệt bài không thành công', 'error');
                        easy2getroom.stopLoading();
                    }
                })
            })
    ...
    function loadDetail(that) {
        ...
        $.ajax({
            type: 'Get',
            url: '/Admin/AwaitingApprovalProperty/GetById',
            data: {
                id: that,
            },
            dataType: 'JSON',
    ...
    function loadData(isPageChanged) {
        ...
        $.ajax({
            type: 'GET',
            url: '/admin/AwaitingApprovalProperty/GetAllPaging',
            data: {
